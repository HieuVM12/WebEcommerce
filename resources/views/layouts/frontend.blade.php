        ...
        <header class="header bg-white">
            <div class="container px-lg-3">
                <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand"
                        href="{{url('/index')}}"><span class="fw-bold text-uppercase text-dark">ZAY</span></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto">
                            <li class="nav-item">
                                <!-- Link--><a class="nav-link active" href="{{url('/index')}}">Trang chủ</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="pagesDropdown"
                                    ...
                                    aria-expanded="false">{{$parent_category->name }}</a>
                                <div class="dropdown-menu mt-3 shadow-sm" aria-labelledby="pagesDropdown">
                                    ...
                                    <a class="dropdown-item border-0 transition-link"
                                        href="{{url('/'.$child_category->slug)}}">{{$child_category->name }}</a>
                                    @endif
                                    @endforeach
                                </div>
                            </li>
                        ...
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item"><a class="nav-link" href="{{url('/cart')}}"> <i
                                        ...
                                        class="text-gray fw-normal">(@livewire('frontend.cart.cart-count'))</small></a></li>
                            <li class="nav-item"><a class="nav-link" href="{{route('wishlist')}}"> <i
                                        class="far fa-heart me-1"></i><small class="text-gray fw-normal">
                                        (@livewire('frontend.wishlist-count'))</small></a></li>
                            @guest
                            @if (Route::has('login'))
                            <li class="nav-item">
